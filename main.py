...
from tkinter import messagebox, filedialog, Frame, Menu, Button, Label, Canvas, Scrollbar
...
class Front:
    ...
    def login(self):
        ...
        self.master.geometry('1080x1920+300+100')
        ...
        self.menu_count = 0
        self.logo = PhotoImage(file='BAUETpay.png').subsample(3,3)
        self.bg = PhotoImage(file='BAUETpaywht.png')
        ...
        background_label = Label(image=self.bg)
        background_label.place(x=0, y=0, relwidth=1, relheight=1)

        self.frame_body = ttk.Frame(self.master)
        self.frame_body.pack()
        self.frame_body.config(relief=RIDGE, padding=(30, 100))
    ...
    def forgot(self):
        ...
        self.master.geometry('1080x720+300+100')
        self.frame_body.pack_forget()
        self.frame_body = ttk.Frame(self.master)
        self.frame_body.pack()
    ...
    def menu_ini(self):
        ...
        self.fribut = ttk.Button(
            self.frame_menu, text="Your Bank Accounts", command=self.friends)
    ...
    def search(self):
        ...
        search_combo.config(values=('Search by Name: ', 'Search by Account Number: '))
